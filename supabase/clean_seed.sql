-- Sample seed file for local development
...
SET 
  bio = CASE id
    WHEN '00000000-0000-0000-0000-000000000001' THEN 'Cannabis enthusiast and reviewer. Love exploring new strains! 🌿'
    WHEN '00000000-0000-0000-0000-000000000002' THEN 'Medicinal cannabis advocate. Sharing honest reviews.'
    WHEN '00000000-0000-0000-0000-000000000003' THEN 'Cannabis educator and advocate. I believe in the healing power of this amazing plant.'
    WHEN '00000000-0000-0000-0000-000000000004' THEN 'Recreational user with a passion for discovering unique terpene profiles.'
    WHEN '00000000-0000-0000-0000-000000000005' THEN 'Home grower and cannabis connoisseur. Ask me about my latest harvest!'
  END,
  avatar_url = CASE id
    WHEN '00000000-0000-0000-0000-000000000001' THEN 'https://ui-avatars.com/api/?name=Jane+Green&background=10B981&color=fff'
    WHEN '00000000-0000-0000-0000-000000000002' THEN 'https://ui-avatars.com/api/?name=Mike+Blaze&background=7C3AED&color=fff'
    WHEN '00000000-0000-0000-0000-000000000003' THEN 'https://ui-avatars.com/api/?name=Cannabis+Queen&background=F59E0B&color=fff'
    WHEN '00000000-0000-0000-0000-000000000004' THEN 'https://ui-avatars.com/api/?name=Herb+Explorer&background=EF4444&color=fff'
    WHEN '00000000-0000-0000-0000-000000000005' THEN 'https://ui-avatars.com/api/?name=Green+Thumb&background=3B82F6&color=fff'
  END;
